/*await_fix.js
Demonstration of how async and await along with promises can make asynchronous
code pretty easy to work with
...
//use async and await
//note that the async label has been applied to the callback passed to question
