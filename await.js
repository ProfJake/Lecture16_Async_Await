...
//since main is labeled as async
//it implicitly returns a promise
async function main(){
    //await allows this code to pause while it waits
    //for the  promise to fulfill. On return
    //statements this allows a promise to reject and
